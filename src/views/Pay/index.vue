  ...
  methods: {
    async submit() {
      ...
      QRCode.toDataURL(result.codeUrl)
        .then((url) => {
          this.$alert(
            ...
            "请使用微信支付扫码",
            {
              ...
              confirmButtonText: "我已成功支付", // 成功按钮
              cancelButtonText: "支付过程中出现问题", // 取消按钮
              center: true, //居中布局
              dangerouslyUseHTMLString: true, // 设置这个为true才会解析html
            }
          )
          //点击成功按钮触发
            .then(() => {
        ...
        .catch(() => {
          this.$message.error("支付遇到了问题，请重新试一试");
        });
    },
  },
};
